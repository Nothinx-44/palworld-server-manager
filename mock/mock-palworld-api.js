...
// Quelques joueurs fictifs pour avoir quelque chose à afficher
let players = [
  { name: 'Copain1', accountName: 'copain1#1234', playerId: '1', userId: 'user-001', ip: '82.12.34.56', ping: 42, level: 23, building_count: 12 },
  { name: 'Copain2', accountName: 'copain2#5678', playerId: '2', userId: 'user-002', ip: '90.45.67.89', ping: 67, level: 8, building_count: 3 }
];
